...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "source",
            sa.Enum("wordfence", "nvd", "cve", "local", name="feedsource", native_enum=False, length=32),
            nullable=False,
        ),
        ...
        sa.Column(
            "auth_type",
            sa.Enum("none", "bearer", "header", "query", name="feedauth", native_enum=False, length=16),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "software_type",
            sa.Enum("plugin", "theme", "core", name="softwaretype", native_enum=False, length=16),
            nullable=False,
        ),
        ...
        sa.Column("priority_score", sa.Double(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "role", sa.Enum("admin", "manager", "user", name="userrole", native_enum=False, length=16), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column("cvss_score", sa.Double(), nullable=True),
        sa.Column("cvss_vector", sa.String(length=255), nullable=True),
        sa.Column(
            "severity",
            sa.Enum("none", "low", "medium", "high", "critical", name="severity", native_enum=False, length=16),
            nullable=False,
        ),
    ...
    op.create_index(
        "ix_vulnerabilities_severity_published", "vulnerabilities", ["severity", "published_at"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "kind",
            sa.Enum(
                "scan", "crawl", "feeds", "match", "report", "source_scan", name="runkind", native_enum=False, length=32
            ),
            nullable=False,
        ),
        sa.Column(
        ...
        sa.Column("updated_at", sa.DateTime(), server_default=sa.text("now()"), nullable=False),
        sa.ForeignKeyConstraint(
            ["started_by_id"], ["users.id"], name=op.f("fk_runs_started_by_id_users"), ondelete="SET NULL"
        ),
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.DateTime(), server_default=sa.text("now()"), nullable=False),
        sa.ForeignKeyConstraint(
            ["updated_by_id"], ["users.id"], name=op.f("fk_settings_updated_by_id_users"), ondelete="SET NULL"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["software_id"], ["software.id"], name=op.f("fk_software_tags_software_id_software"), ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "release_status",
            sa.Enum("latest", "outdated", "insecure", "unknown", name="releasestatus", native_enum=False, length=16),
            nullable=False,
        ),
        sa.Column("issue_count", sa.Integer(), nullable=False),
        ...
        sa.Column("updated_at", sa.DateTime(), server_default=sa.text("now()"), nullable=False),
        sa.ForeignKeyConstraint(
            ["software_id"], ["software.id"], name=op.f("fk_software_versions_software_id_software"), ondelete="CASCADE"
        ),
    ...
    op.create_index(
        "ix_software_versions_software_key", "software_versions", ["software_id", "version_key"], unique=False
    )
    op.create_table(
        "user_sessions",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["vulnerability_id"],
            ["vulnerabilities.id"],
            name=op.f("fk_vulnerability_affects_vulnerability_id_vulnerabilities"),
            ondelete="CASCADE",
        ),
    ...
    op.create_index(
        "ix_vulnerability_affects_range", "vulnerability_affects", ["slug", "from_key", "to_key"], unique=False
    )
    op.create_index(
        "ix_vulnerability_affects_slug_type", "vulnerability_affects", ["slug", "software_type"], unique=False
    )
    op.create_table(
        "findings",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["affect_id"],
            ["vulnerability_affects.id"],
            name=op.f("fk_findings_affect_id_vulnerability_affects"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["assigned_to_id"], ["users.id"], name=op.f("fk_findings_assigned_to_id_users"), ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["first_run_id"], ["runs.id"], name=op.f("fk_findings_first_run_id_runs"), ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["last_run_id"], ["runs.id"], name=op.f("fk_findings_last_run_id_runs"), ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["software_id"], ["software.id"], name=op.f("fk_findings_software_id_software"), ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["software_version_id"],
            ["software_versions.id"],
            name=op.f("fk_findings_software_version_id_software_versions"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["vulnerability_id"],
            ["vulnerabilities.id"],
            name=op.f("fk_findings_vulnerability_id_vulnerabilities"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.DateTime(), server_default=sa.text("now()"), nullable=False),
        sa.ForeignKeyConstraint(
            ["run_id"], ["runs.id"], name=op.f("fk_webhook_deliveries_run_id_runs"), ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(), server_default=sa.text("now()"), nullable=False),
        sa.ForeignKeyConstraint(
            ["finding_id"], ["findings.id"], name=op.f("fk_finding_events_finding_id_findings"), ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("fk_finding_events_user_id_users"), ondelete="SET NULL"
        ),
